...
public class ArrayLinkedList<E> {
	...
	class Node<E> {
		private E data; // data
		private int next; 
		private int dnext; // free 리스트의 뒤쪽 포인
	...
	private Node<E>[] n; // list
	private int size; // capacity of list
	private int max; // tail record in use
	private int head; // head node
	private int crnt; // selected node
	private int deleted; // head node of list free
	private static final int NULL = -1; // no next node / list is full
